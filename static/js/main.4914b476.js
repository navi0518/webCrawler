/*! For license information please see main.4914b476.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, t, n) => {
          ...
          if ($t) {
            ...
            if (null === a) $r(e, t, r, Kt, n), Dt(e, r);
              ...
              for (; null !== a; ) {
                ...
                if (
                  (null !== l && kt(l),
                  null === (l = Jt(e, t, n, r)) && $r(e, t, r, Kt, n),
                  l === a)
                )
                  break;
                a = l;
        ...
        function Jl(e, t) {
          switch ((_a(Ql, t), _a(ql, e), _a(Wl, $l), (e = t.nodeType))) {
            case 9:
            case 11:
          ...
          Zo = {
            ...
            useTransition: function () {
              var e = Ro(!1),
                t = e[0];
              return (
                (e = Wo.bind(null, e[1])), (vo().memoizedState = e), [t, e]
              );
            },
        ...
        function ui(e, t, n, r) {
          ...
          "object" === typeof l && null !== l
            ? (a.context = Rl(l))
            : ((l = La(t) ? Ra : Na.current), (a.context = Oa(e, l))),
        ...
        function Ni(e, t, n, r, a, l) {
          Ci(e, t);
          var o = 0 !== (128 & t.flags);
          if (!r && !o) return a && ja(t, n, !1), $i(e, t, l);
        ...
        var Eu,
          ...
          Zu = 0;
        function es() {
          return 0 !== (6 & Nu) ? Ye() : -1 !== Gu ? Gu : (Gu = Ye());
        }
        function ts(e) {
          return 0 === (1 & e.mode)
            ? 1
        ...
        function cs(e) {
          ...
          try {
            ...
            (bt = r), (Tu.transition = n), 0 === (6 & (Nu = t)) && Va();
          }
        }
        function fs() {
          (Lu = zu.current), Ca(zu);
        ...
        function gs(e, t) {
          ...
          if ((_l(), (Nu = n), (Cu.current = r), null !== Ru))
            throw Error(l(261));
  ...
  const g = d("string"),
    ...
    x = f("FileList"),
    C = f("URLSearchParams"),
    [_, T, N, P] = ["ReadableStream", "Request", "Response", "Headers"].map(f);
  function R(e, t) {
    let n,
      r,
      { allOwnKeys: a = !1 } =
  ...
  const L =
    ...
    z = (e) => !h(e) && e !== L;
  const F =
    ((D = "undefined" !== typeof Uint8Array && u(Uint8Array)),
    (e) => D && e instanceof D);
  var D;
  const A = f("HTMLFormElement"),
    j = ((e) => {
    ...
    B = "0123456789",
    V = { DIGIT: B, ALPHA: I, ALPHA_DIGIT: I + I.toUpperCase() + B };
  const H = f("AsyncFunction"),
    $ = ((e, t) => {
      return e
        ? setImmediate
        : t
        ...
        : (e) => setTimeout(e);
      var n, r;
    })("function" === typeof setImmediate, y(L.postMessage)),
    W =
    ...
    q = {
      ...
      isAsyncFn: H,
      isThenable: (e) => e && (b(e) || y(e)) && y(e.then) && y(e.catch),
      setImmediate: $,
      asap: W,
    };
  ...
  const ee = q.toFlatObject(q, {}, null, function (e) {
          ...
          return (
            ...
            i.forEach(function (e, r) {
              !q.isUndefined(e) &&
                null !== e &&
                t.append(
                  !0 === o ? Z([n], r, l) : null === o ? n : n + "[]",
                  u(e)
                );
            }),
            !1
          );
      return !!Y(e) || (t.append(Z(a, n, l), u(e)), !1);
    }
    const c = [],
      f = Object.assign(ee, {
        defaultVisitor: s,
  ...
  const ue = class {
    ...
    de =
      ((pe = "undefined" !== typeof navigator && navigator.product),
      fe && ["ReactNative", "NativeScript", "NS"].indexOf(pe) < 0);
  var pe;
  const he =
  ...
  const ve = {
    ...
    transformRequest: [
      function (e, t) {
        ...
        if (q.isFormData(e)) return r ? JSON.stringify(ye(e)) : e;
        if (
          q.isArrayBuffer(e) ||
          q.isBuffer(e) ||
          q.isStream(e) ||
        ...
        if (a) {
          ...
          if ((l = q.isFileList(e)) || n.indexOf("multipart/form-data") > -1) {
          ...
          try {
            ...
            if (n) {
              if ("SyntaxError" === a.name)
                throw X.from(a, X.ERR_BAD_RESPONSE, this, null, this.response);
              throw a;
            }
          }
        }
  ...
  class Ce {
    ...
    set(e, t, n) {
      ...
      if (q.isPlainObject(e) || e instanceof this.constructor) l(e, t);
      else if (
        q.isString(e) &&
        (e = e.trim()) &&
      ...
      else if (q.isHeaders(e)) for (const [o, i] of e.entries()) a(i, o, n);
      else null != e && a(t, e, n);
      return this;
    }
    get(e, t) {
    ...
    has(e, t) {
      if ((e = Se(e))) {
        const n = q.findKey(this, e);
        return !(!n || void 0 === this[n] || (t && !xe(0, this[n], n, t)));
      }
      return !1;
    }
    delete(e, t) {
      ...
      function a(e) {
        if ((e = Se(e))) {
          ...
          !a || (t && !xe(0, n[a], a, t)) || (delete n[a], (r = !0));
        }
      }
    ...
    clear(e) {
      ...
      for (; n--; ) {
        const a = t[n];
        (e && !xe(0, this[a], a, e, !0)) || (delete this[a], (r = !0));
      }
      return r;
    }
    normalize(e) {
      ...
      return (
        q.forEach(this, (r, a) => {
          ...
          if (l) return (t[l] = Ee(r)), void delete t[a];
          const o = e
            ? (function (e) {
                return e
                  .trim()
  ...
  Ce.accessor([
    ...
    q.reduceDescriptors(Ce.prototype, (e, t) => {
      let { value: n } = e,
  ...
  const Ie = (e) => (e instanceof _e ? { ...e } : e);
  function Be(e, t) {
    t = t || {};
    const n = {};
    function r(e, t, n) {
  ...
  const Ve = (e) => {
      ...
      if (
        ((t.headers = i = _e.from(i)),
        (t.url = ie(Ue(t.baseURL, t.url), e.params, e.paramsSerializer)),
        u &&
          i.set(
            "Authorization",
            "Basic " +
      ...
      if (
        ...
        (a && q.isFunction(a) && (a = a(t)), a || (!1 !== a && je(t.url)))
      ) {
        const e = l && o && Me.read(o);
        e && i.set(l, e);
      }
      return t;
    },
    He =
      ...
      function (e) {
        return new Promise(function (t, n) {
          const r = Ve(e);
          let a = r.data;
          const l = _e.from(r.headers).normalize();
          let o,
            i,
            u,
            s,
          ...
          m.open(r.method.toUpperCase(), r.url, !0),
            ...
            (m.onabort = function () {
              m &&
                (n(new X("Request aborted", X.ECONNABORTED, e, m)), (m = null));
            }),
            (m.onerror = function () {
            ...
            (m.ontimeout = function () {
              ...
              r.timeoutErrorMessage && (t = r.timeoutErrorMessage),
                n(
                  new X(
                    t,
                    a.clarifyTimeoutError ? X.ETIMEDOUT : X.ECONNABORTED,
                    e,
                    m
                  )
                ),
          ...
          y && -1 === ge.protocols.indexOf(y)
            ? n(new X("Unsupported protocol " + y + ":", X.ERR_BAD_REQUEST, e))
            : m.send(a || null);
        });
      },
    $e = (e, t) => {
      ...
      const a = function (e) {
        if (!n) {
          ...
          r.abort(
            t instanceof X ? t : new Re(t instanceof Error ? t.message : t)
          );
        }
      };
      let l =
        t &&
        setTimeout(() => {
          a(new X(`timeout ${t} of ms exceeded`, X.ETIMEDOUT));
        }, t);
      const o = () => {
        e &&
          (l && clearTimeout(l),
    ...
    qe = (e, t, n, r, a) => {
      const l = (async function* (e, t, n) {
        for await (const r of e)
          yield* We(ArrayBuffer.isView(r) ? r : await n(String(r)), t);
      })(e, t, a);
      let o,
        i = 0,
        u = (e) => {
      ...
      return new ReadableStream(
        {
          async pull(e) {
            try {
              const { done: t, value: r } = await l.next();
  ...
  const Ye = function (e) {
    ...
    Ze = Ke && Ye(() => q.isReadableStream(new Response("").body)),
      ...
      return null == n
        ? (async (e) =>
            null == e
              ...
              : q.isArrayBufferView(e) || q.isArrayBuffer(e)
              ? e.byteLength
              : (q.isURLSearchParams(e) && (e += ""),
                q.isString(e) ? (await Je(e)).byteLength : void 0))(t)
        : n;
    },
    rt = {
      http: null,
          ...
          try {
            if (
              ...
              if (
                ...
                const [e, t] = De(v, Fe(Ae(u)));
                r = qe(n.body, 65536, e, t, Je);
              }
            }
            ...
            let a = await fetch(h);
            const l = Ze && ("stream" === s || "response" === s);
            if (Ze && (i || l)) {
              const e = {};
              ["status", "statusText", "headers"].forEach((t) => {
                e[t] = a[t];
              });
              const t = q.toFiniteNumber(a.headers.get("content-length")),
                [n, r] = (i && De(t, Fe(Ae(i), !0))) || [];
              a = new Response(
                qe(
                  a.body,
                  65536,
            ...
            s = s || "text";
            let o = await et[q.findKey(et, s) || "text"](a, e);
            return (
              !l && y(),
              g && g(),
            ...
            if ((y(), b && "TypeError" === b.name && /fetch/i.test(b.message)))
              throw Object.assign(new X("Network Error", X.ERR_NETWORK, e, h), {
                cause: b.cause || b,
              });
    ...
    ot = (e) => {
      ...
      for (let l = 0; l < t; l++) {
        ...
        if (
          ((n = e[l]),
          (r = n),
          !lt(n) && ((r = rt[(t = String(n)).toLowerCase()]), void 0 === r))
        )
  ...
  function ut(e) {
    ...
    return ot(e.adapter || be.adapter)(e).then(
      function (t) {
        return (
          it(e),
      ...
      function (t) {
        return (
          Ne(t) ||
            ...
            t &&
              t.response &&
              ((t.response.data = Te.call(e, e.transformResponse, t.response)),
              (t.response.headers = _e.from(t.response.headers)))),
          Promise.reject(t)
        );
      }
    );
  ...
  const wt = (function e(t) {
    const n = new mt(t),
      r = o(mt.prototype.request, n);
    return (
      q.extend(r, mt.prototype, n, { allOwnKeys: !0 }),
  ...
  (wt.Axios = mt),
    ...
    (wt.mergeConfig = Be),
    (wt.AxiosHeaders = _e),
    (wt.formToJSON = (e) => ye(q.isHTMLForm(e) ? new FormData(e) : e)),
    (wt.getAdapter = ot),
  ...
  const Et = function () {
      ...
      return (0, St.jsxs)("div", {
        className: "App",
        children: [
          (0, St.jsx)("h1", { children: "Contact Info Scraper" }),
          (0, St.jsxs)("form", {
            onSubmit: async (t) => {
              t.preventDefault(), o(!0), u(null);
              try {
                const t = await kt.post("http://localhost:5001/api/scrape", {
                    url: e,
                  }),
                  n = t.data.emails.filter((e) =>
                    /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)
                  ),
                  a = t.data.phone_numbers.filter((e) => /^\d+$/.test(e));
                r({ emails: n, phone_numbers: a });
              } catch (n) {
                u("An error occurred during scraping."), console.error(n);
              } finally {
                o(!1);
              }
            },
            children: [
              ...
              (0, St.jsx)("button", { type: "submit", children: "Scrape" }),
              (0, St.jsx)("button", {
                type: "button",
                onClick: () => {
                  t(""), r(null), o(!1), u(null);
          ...
          l && (0, St.jsx)("p", { children: "Loading..." }),
          i && (0, St.jsx)("p", { children: i }),
          n &&
            (0, St.jsxs)("div", {
              className: "results",
              children: [
                (0, St.jsx)("h2", { children: "Results" }),
                n.emails.length > 0
                  ? (0, St.jsxs)("div", {
                      children: [
                        (0, St.jsx)("h3", { children: "Emails" }),
                        n.emails.map((e, t) =>
                          (0, St.jsx)(
                            "div",
                            { className: "email-item", children: e },
                            t
                          )
                        ),
                      ],
                    })
                  : (0, St.jsx)("p", { children: "No emails found." }),
                n.phone_numbers.length > 0
                  ? (0, St.jsxs)("div", {
                      children: [
                        (0, St.jsx)("h3", { children: "Phone Numbers" }),
                        n.phone_numbers.map((e, t) =>
                          (0, St.jsx)(
                            "div",
                            { className: "phone-item", children: e },
                            t
                          )
                        ),
                      ],
                    })
                  : (0, St.jsx)("p", { children: "No phone numbers found." }),
              ],
            }),
          null === n &&
            !l &&
            !i &&
            (0, St.jsx)("p", { children: "Submit a URL to see results." }),
        ],
      });
    },
    xt = (e) => {
  ...
  l
    ...
    .render((0, St.jsx)(a.StrictMode, { children: (0, St.jsx)(Et, {}) })),
    xt();
})();
//# sourceMappingURL=main.4914b476.js.map
